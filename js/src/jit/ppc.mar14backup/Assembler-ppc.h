...
class Assembler : public AssemblerShared
{
  ...
  public:
    ...
    static void PatchWrite_Imm32(CodeLocationLabel label, Imm32 imm) { MOZ_CRASH("PPC: NYI"); }
    static void PatchWrite_NearCall(CodeLocationLabel start, CodeLocationLabel toCall) { MOZ_CRASH("PPC: NYI"); }
